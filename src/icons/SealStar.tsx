    ...
    <div className={dropShadow('drop-shadow-gold')}>
      <div className={wrapper(small)}>
        <svg viewBox="0 0 50 38" xmlns="http://www.w3.org/2000/svg">
          ...
          />
          <path className={commonPath} d="M48.4618 24.0483L39.8242 25.4902" />
          <path className={commonPath} d="M39.8272 31.4333L48.4648 32.8752" />
          <path className={commonPath} d="M2.38974 24.0474L11.0273 25.4892" />
          <path className={commonPath} d="M11.0321 31.4331L2.39453 32.8749" />
        </svg>
      </div>
    </div>
  )
